...
//	// 멤버변수, 멤버메서드들은 필요한만큼 자유롭게 정의하고 사용할 수 있습니다.
...
//	}
	...
	// 보통 멤버변수의 값을 저장하거나 얻기위한 메서드인데, 그 목적만 있다면 메서드 이름이 반드시 위와 같지는 않아도 무방합니다.
	// 그러나 getter 와 setter 는 개발자가 호출하여 사용하기도 하지만 시스템이 또는 컴파일러가 사용하기도 하기 떄문에 약속된 이름(get변수이름, set변수이름)을 사용한것이 일반적입니다
	...
	// 이클립스는 현재위치에서 마우스 우클릭 -> Source -> Generate Getters and Setters
...
//           같은 패키지 내에서 public 처럼 자유롭게 접근 가능합니다. 외부패키지에서는 private 이나 마찬가지
