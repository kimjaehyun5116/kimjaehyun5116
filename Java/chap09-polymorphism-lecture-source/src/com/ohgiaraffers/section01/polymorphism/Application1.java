...
public class Application1 {
    public static void main(String[] args) {
         ...
         * 그렇기 때문에 휴ㅏ나의 타입으로 여러 타입의 인스턴스를 처리할 수 있기도 하고,
         * 하나의 메서드 호출로 객체별로 각기 다른 방법으로 동작할 수 있다.
         * */
...
//        Tiger t = new Animal();       //에러남
         ...
         * 런타입 당시의 실제 객체가 가진 오버라이딩된 메서드로 바인딩이 바뀌어 동작하는 것을 의미한다.*/
