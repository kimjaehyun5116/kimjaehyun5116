...
public class Application2 {
    public static void main(String[] args) {
        ...
        /*
         * API문서를 살펴보면 Calendar 클래스는 abstract클래스로 작성되어있다
         * 따라서 Calendar 클래스는 이용해서 인스턴스를 생성하는 것이 불가능하다.
         * */

        /* Calendar 클래스를 이용한 인스턴스 생성 방법에는 크게 두 가지가 있다
         * getInstance() static 메소드를 이용해서 인스턴스를 반환받는 방법
        ...
        Calendar birtthday = new GregorianCalendar(year, month, dayOfMonth, hour, min, second);


        System.out.println("birtthday = " + birtthday);
