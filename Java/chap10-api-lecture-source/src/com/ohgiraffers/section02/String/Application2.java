...
public class Application2 {
    public static void main(String[] args) {
        ...
        * new String("문자열") : 매번 새로운 인스턴스를 ㅎ생성한다.
        * */
        ...
        * 동일한 문자열은 동일한 hashCode를 반환한다.*/
        ...
        System.out.println("str1.hastCode() = " + str1.hashCode());
        System.out.println("str2.hastCode() = " + str2.hashCode());
        System.out.println("str3.hastCode() = " + str3.hashCode());
        System.out.println("str4.hastCode() = " + str4.hashCode());
