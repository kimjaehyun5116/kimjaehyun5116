...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 인덱스를 벗어난 정수를 인자로 전달하는 경우 indexDutBoundException이 발생한다
        * */
        ...
        * */
        ...
        System.out.println("compareTo() : " + (str4.compareTo(str2)));      //-32   작은면 음수
        ...
        * */
        ...
        /*
        * indexOf() : 문자열에서 특정 문자를 탐색하여 처음 일치하는 언덱스 위치를 정수형으로 반환한다.
        ...
        * */
        ...
        /* trim() : 문자열의 앞 위에 공백을 제기한 문자열을 반환한다. */
        ...
        * */
        ...
        System.out.println("javaoracle = " + javaoracle.substring(3));

        System.out.println("javaoracle" + javaoracle);

        /* replace() : 문자열에서 대체할 문자열로 기준 문자열을 변경해서 변환한다.*/
        ...
        System.out.println("빈 문자열의 길이 "+("    java      ".length()));

        /*isEmpty() : 문자열 길이가 0이면 true를 아니면 false를 반환 */
