...
public class Application1 {
    public static void main(String[] args) {
        /* Object 클래스의 toString() 메서드 오버라이딩 목적을 이해하고 활용할 수 있다. */
        /*
        * 모든 클래스는 Object클래스의 후손이다
        * 따라서 Object클래스가 가진 메서드를 자신의 것처럼 사용할 수 있다.
        * 또한 부모 클래스가 가지는 메서드를 오버라이딩 해서 사용하는 것도 가능하다.
        * */

        /*
        * Object 클래스의 메서드 중 관례상 많이 오버라이딩해서 사용하는 메서드들이 있다.
