...
// 19세 이하는 되돌아감. 19세 이상이면 통과페이지로 이동(20세 미만이므로 입장이 불가합니다. 라는 경고창 표시)
// 20세 미만일때 "입장이 불가합니다" 라는 alert창 표시하고 되돌아갑니다
...
%>
	...
	<!-- html head body등이 없다고 해서 다른테그를 사용하지 못하는게 아닙니다. 그들은 양식일뿐 html 테그는
...
<%
	...
	request.setAttribute("name", "김재현"); // "name"이 Key, "홍길동"이 Value
	
	// request와 respnse을 담고 이동(forward)할 객체를 생성합니다
