...
public class Application1 {
    public static void main(String[] args){
        ...
        /* 변수의사용 목적을 이해할 수 있다 */
        /* 변수의 사용 목적
         *  1. 값에 의미를 부여하기 위한 목적(의미 전달이 쉬워야 코드가 쉬워지고, 협업 및 유지보수에 유리하기 때문이다.)
...
<<<<<<< HEAD
        ...
        sum = sum +10;
        System.out.println("sum에 10을 있었으니 10을 추가로 더하면 sum의 값은?" + sum);

        sum = sum +10;
        System.out.println("sum에 20을 있었으니 10을 추가로 더하면 sum의 값은?" + sum);
