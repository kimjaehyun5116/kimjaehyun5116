...
public class Application3 {
    public static void main(String[] args) {
        ...
        int age1 = 10; //숫자가 처음에 시작하지 않으면 섞어서 사용ㄷ오 가능함
        ...
        /* 목차 2-2 변수명이 합성어로 이루어진 경우 첫 단어는 소문자 두 번째ㅑ 시작 단어는 대문자로 시작한다.*/
        ...
        /* 목차 2-6 변수 안에 저장된 값이 어떤 의미를 가지는지 정확하게 표현하도록 한다!*/
        String s;
        ...
        /* 목차 2-8ㅑ.boolean 형은 의문문으로 가급적 긍정상태로 네이밍한다.*/
