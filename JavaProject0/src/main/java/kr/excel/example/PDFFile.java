...
public class PDFFile {
    ...
    public void createPdf(String dest) throws MalformedURLException, IOException {
        ...
        try {
            headerFont = PdfFontFactory.createFont("D2Coding-Ver1.3.2-20180524.ttf", "Identity-H", true);
            bodyFont = PdfFontFactory.createFont("D2Coding-Ver1.3.2-20180524.ttf", "Identity-H", true);
