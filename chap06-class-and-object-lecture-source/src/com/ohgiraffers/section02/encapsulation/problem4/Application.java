...
public class Application {
    public static void main(String[] args) {
        ...
        /* 1. private에 필드에 직접 접근하여 compil error를 발생 확인 */
...
/*        monster1.kinds = "피카츄";   //에러발생
        ...
        /*캡슐화는 유지보수정을 증가시키기 위해 직접 접근을 제한하고
        * public메소드 이용해서 간접적으로 접근하여 사용할 수 있도록 만든 기술이다.
        * 글래스 작성 시 특별한 목적이 아닌 이상 캡슐화를 기본 원칙으로 사용되고 있다.
        * */
    }
}
