...
// 3. 일반 맴버변수와 일반 맴버 메서드를 가질 수 없습니다
// 4. 다만 자바의 버전이 올라가면서 일반 멤버를 갖을 수 있게 되었습니다. 웹 프로그램에서는 쓰지 않을 예정
// 5. 하나이상의 추상메서드를 포함합니다
// 6. 다중 상속이 가능합니다

import static days0507.Abstract01.method1;
...
// 인터페이스를 상속(구현)하는 클래스는 상속(구현)할 클래스 앞에 extends 대신 implements를 씁니다
